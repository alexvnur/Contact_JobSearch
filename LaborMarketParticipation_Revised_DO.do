...
*****************************************************************************
/*
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 1 - Data Cleaning", ///
	text replace

cd "D:\Holly\Job Search\LMParticipation_PublicFiles\DataPull_PSID"
...
cd "D:\Holly\Job Search\LMParticipation_PublicFiles\DataPull_PSID\Cleaned"
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 2 - Market States", ///
	text replace
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 3 - Data Assessments", ///
	text replace

use "D:\Holly\Job Search\LMParticipation_PublicFiles\DataPull_PSID\Cleaned\FinalData_Cleaned.dta", clear
...
--------------------+---------------------+-------------------------------------
IV					| Contact_L1		  | Any history of criminal legal contact
...
cd "D:\Holly\Job Search\New Data 8.1.23"
...
***
*DICHOTOMOUS CRIMINAL JUSTICE CONTACT VARIBALE
***
gen Contact_L1 = .
label define contact 0"No history of contact" 1"History of contact"
foreach x in ArrestEver_L1 JailEver_L1 ProbationEver_L1 {
	replace Contact_L1 = 1 if `x' == 1
}
	replace Contact_L1 = 0 if ArrestEver_L1 == 0 & JailEver_L1 == 0 & ///
		ProbationEver_L1 == 0
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 4 - Descriptive Statistics", ///
	text replace
...
reg Searching_Total WorryJob_L1 Contact_L1 $contact $l1control $l2control, cluster(ParticipantID)
	gen sample = e(sample)
...
*Missingness
misstable sum $state WorryJob_L1 Contact_L1 $contact $l1control $l2control if sample != .
misstable pattern $state WorryJob_L1 Contact_L1 $contact $l1control $l2control if sample != .

foreach x in $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 {
	ttest `x', by(sample)
}

foreach x in Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
...
sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 ///
	if sample == 1
tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
...
tab1 Sex Race if sample_ever == 1 & wave == 5
	...
	*Descriptive values by sample inclusion status
	sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 // all data
	tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
		UnemploymentComp_L1 AlcUse_L1 Crash_L1 ForceOut_L1 // all data
	tab1 Sex Race if wave == 5 // all data
		
	sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 ///
		if sample == 0 // excluded sample
	tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
		UnemploymentComp_L1 AlcUse_L1 Crash_L1 ForceOut_L1 ///
		if sample == 0 // excluded sample
	tab1 Sex Race if sample_ever != 1 & wave == 5 // excluded sample
	
	
*Descriptive values by contact history
	*Arrest
	sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 ///
		if sample == 1 & ArrestEver_L1 == 1
	tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
		UnemploymentComp_L1 AlcUse_L1 Crash_L1 ForceOut_L1 ///
		if sample == 1 & ArrestEver_L1 == 1
	
	bysort ParticipantID: egen arrestmax = max(ArrestEver_L1)
		// to accurately assess L2 measures with any contact	
	tab1 Sex Race if sample_ever == 1 & wave == 5 & arrestmax == 1
		// only need to assess based on sample inclusion (ever) and one wave of data
		
	*Jail
	sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 ///
		if sample == 1 & JailEver_L1 == 1
	tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
		UnemploymentComp_L1 AlcUse_L1 Crash_L1 ForceOut_L1 ///
		if sample == 1 & JailEver_L1 == 1
	
	bysort ParticipantID: egen jailmax = max(JailEver_L1)
		// to accurately assess L2 measures with any contact	
	tab1 Sex Race if sample_ever == 1 & wave == 5 & jailmax == 1
		// only need to assess based on sample inclusion (ever) and one wave of data
		
	*Probation
	sum $state WorryJob_L1 Health_L1 FINScale_L1 DISScale_L1 Risky_L1 AGE_L1 ///
		if sample == 1 & ProbationEver_L1 == 1
	tab1 Contact_L1 $contact GraduatedHS_L1 EnrollNow_L1 Relationship_L1 Kids_L1 ///
		UnemploymentComp_L1 AlcUse_L1 Crash_L1 ForceOut_L1 ///
		if sample == 1 & ProbationEver_L1 == 1
	
	bysort ParticipantID: egen probationmax = max(ProbationEver_L1)
		// to accurately assess L2 measures with any contact	
	tab1 Sex Race if sample_ever == 1 & wave == 5 & probationmax == 1
		// only need to assess based on sample inclusion (ever) and one wave of data


*Correlations
corr $state WorryJob_L1 Contact_L1 $contact $l1control $l2control if sample == 1
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 5 - Main Models", ///
	text replace

*Macros for Models
global state Employed_Total Searching_Total Discgd_Total
global contact ArrestEver_L1 JailEver_L1 ProbationEver_L1
	// Any Contact: Contact_L1
...
**OLOGIT MODELS
**Any Contact
meologit WorryJob Contact_L1 if sample == 1 || ParticipantID: , or // bivariate
quietly: meologit WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	test Contact_L1
quietly: meologit WorryJob i.Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	margins Contact_L1

**Arrest
meologit WorryJob ArrestEver_L1 if sample == 1 || ParticipantID: , or // bivariate
quietly: meologit WorryJob ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	test ArrestEver_L1
		// chi2 = 2.46
		// p = 0.1169
meologit WorryJob i.ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	margins ArrestEver_L1

**Jail
meologit WorryJob JailEver_L1 if sample == 1 || ParticipantID: , or // bivariate
quietly: meologit WorryJob JailEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	test JailEver_L1
		// chi2 = 3.22
		// p = 0.0726
meologit WorryJob i.JailEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	margins JailEver_L1

**Probation
meologit WorryJob ProbationEver_L1 if sample == 1 || ParticipantID: , or // bivariate
quietly: meologit WorryJob ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	test ProbationEver_L1
		// chi2 = 5.43
		// p = 0.0198
meologit WorryJob i.ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: , or // multivariate
	margins ProbationEver_L1
	marginsplot
	
	
**GOLOGIT2 MODELS
	// relaxed proportional odds assumptions
gologit2 WorryJob ArrestEver_L1 if sample == 1, cluster(ParticipantID) or autofit lrforce // bivariate
gologit2 WorryJob ArrestEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
quietly: gologit2 WorryJob i.ArrestEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
	margins i.ArrestEver_L1

gologit2 WorryJob JailEver_L1 if sample == 1, cluster(ParticipantID) or autofit lrforce // bivariate
gologit2 WorryJob JailEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
quietly: gologit2 WorryJob i.JailEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
	margins i.JailEver_L1
	
gologit2 WorryJob ProbationEver_L1 if sample == 1, cluster(ParticipantID) or autofit lrforce // bivariate
gologit2 WorryJob ProbationEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
quietly: gologit2 WorryJob i.ProbationEver_L1 $l1controlpmc $l2control if sample == 1, cluster(ParticipantID) or autofit lrforce // multivariate
	margins i.ProbationEver_L1
...
mepoisson Discgd_Total Contact_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
mepoisson Searching_Total Contact_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 6 - Supplement - Single Level Models", ///
	text replace
...
**Any Contact
poisson WorryJob Contact_L1 if sample == 1, cluster(ParticipantID) // bivariate
poisson WorryJob Contact_L1 $l1control $l2control  if sample == 1, cluster(ParticipantID) // multivariate
...
poisson Discgd_Total Contact_L1 if sample == 1, cluster(ParticipantID) // bivariate
poisson Discgd_Total WorryJob_L1 Contact_L1 if sample == 1, cluster(ParticipantID) // multivariate
poisson Discgd_Total WorryJob_L1 Contact_L1 $l1control $l2control  if sample == 1, cluster(ParticipantID) // multivariate
...
poisson Searching_Total Contact_L1 if sample == 1, cluster(ParticipantID) // bivariate
poisson Searching_Total WorryJob_L1 Contact_L1 if sample == 1, cluster(ParticipantID) // multivariate
poisson Searching_Total WorryJob_L1 Contact_L1 $l1control $l2control  if sample == 1, cluster(ParticipantID) // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 7 - Supplement - Main Models by Type of Contact", ///
	text replace
	
**********************************************************
*SUPPLEMENTAL MODELS: MAIN MODELS BY TYPE OF LEGAL CONTACT
**********************************************************
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 8 - Supplement - Negative Binomial Models", ///
	text replace
...
**Any Contact
menbreg WorryJob Contact_L1 if sample == 1 || ParticipantID: // bivariate
menbreg WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
menbreg Discgd_Total Contact_L1 if sample == 1 || ParticipantID: // bivariate
menbreg Discgd_Total WorryJob_L1 Contact_L1 if sample == 1 || ParticipantID: // multivariate
menbreg Discgd_Total WorryJob_L1 Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
menbreg Searching_Total Contact_L1 if sample == 1 || ParticipantID: // bivariate
menbreg Searching_Total WorryJob_L1 Contact_L1 if sample == 1 || ParticipantID: // multivariate
menbreg Searching_Total WorryJob_L1 Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 9 - Supplement - Time Employed Outcome", ///
	text replace	
...
**Any Contact
mepoisson Employed_Total WorryJob_L1c pm_WorryJob if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total Contact_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Arrest
mepoisson Employed_Total WorryJob_L1c pm_WorryJob if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total ArrestEver_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Jail
mepoisson Employed_Total WorryJob_L1c pm_WorryJob if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total JailEver_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob JailEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob JailEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Probation
mepoisson Employed_Total WorryJob_L1c pm_WorryJob if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total ProbationEver_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Employed_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 10 - Sensitivity - Alternate LMI Measures", ///
	text replace
***********************************************
...
**Any Contact
mepoisson FUT_Layoff Contact_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson FUT_Layoff Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
mepoisson Discgd_Total FUT_Layoff_L1c pm_FUT_Layoff Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total FUT_Layoff_L1c pm_FUT_Layoff Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
mepoisson Searching_Total FUT_Layoff_L1c pm_FUT_Layoff Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total FUT_Layoff_L1c pm_FUT_Layoff Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
**Any Contact
mepoisson LikelyPayWell Contact_L1 if sample == 1 || ParticipantID: // bivariate
mepoisson LikelyPayWell Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
**Any Contact
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Arrest
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell ArrestEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Jail
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell JailEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell JailEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Probation
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell ProbationEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total LikelyPayWell_L1c pm_LikelyPayWell ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
**Any Contact
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell Contact_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Arrest
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell ArrestEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Jail
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell JailEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell JailEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate

**Probation
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell if sample == 1 || ParticipantID: // bivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell ProbationEver_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total LikelyPayWell_L1c pm_LikelyPayWell ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 11 - Sensitivity - Offense Type and Recency", ///
	text replace	
************************************************************
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 12 - Supplement - Grand Mean Centered Covariates", ///
	text replace
...
**Any Contact
mepoisson WorryJob Contact_L1 $l1controlgmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
mepoisson Discgd_Total WorryJob_L1gmc Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1gmc Contact_L1 $l1controlgmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
mepoisson Searching_Total WorryJob_L1gmc Contact_L1 if sample == 1 || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1gmc Contact_L1 $l1controlgmc $l2control  if sample == 1 || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 13 - Supplement - Age 18 or Older", ///
	text replace
	
**********************************************************
*SUPPLEMENTAL MODELS: MODELS EXLUDING RESPONDENTS UNDER 18
**********************************************************
...
**Any Contact
mepoisson WorryJob Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Arrest
mepoisson WorryJob ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Jail
mepoisson WorryJob JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob JailEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Probation
mepoisson WorryJob ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
...
**Any Contact
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Arrest
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Jail
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob JailEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Probation
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Discgd_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
...
**Any Contact
mepoisson Searching_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob Contact_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate


**Arrest
mepoisson Searching_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Jail
mepoisson Searching_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob JailEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Probation
mepoisson Searching_Total WorryJob_L1c pm_WorryJob if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
mepoisson Searching_Total WorryJob_L1c pm_WorryJob ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
...
log using "D:\Holly\Job Search\LMParticipation_PublicFiles\Log Output\SECTION 14 - Supplement - Contemporanous Insecurity Measure", ///
	text replace
	
********************************************************
*SUPPLEMENTAL MODELS: CONTEMPORANEOUS INSECURITY MEASURE
********************************************************
...
**Any Contact
mepoisson WorryJob_L1 Contact_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob_L1 Contact_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Arrest
mepoisson WorryJob_L1 ArrestEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob_L1 ArrestEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Jail
mepoisson WorryJob_L1 JailEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob_L1 JailEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate

**Probation
mepoisson WorryJob_L1 ProbationEver_L1 if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // bivariate
mepoisson WorryJob_L1 ProbationEver_L1 $l1controlpmc $l2control  if sample == 1 & AGE_L1 > = 18 & AGE_L1 < . || ParticipantID: // multivariate
